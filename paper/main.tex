...
For a more direct comparison between simulation results and PRNs, we have generated a sample of intrinsically disordered proteins \red{cite something}, that also do not contain secondary structures. The results are shown in Fig.~\ref{fig:sdd_idp}.
...
\red{now fill in what we actually did once we finalise this}.
